...
class TypeDoctMoralPersonScreen extends StatelessWidget {
  const TypeDoctMoralPersonScreen({super.key});
      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Documentos para personas morales', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Color.fromRGBO(2, 63, 120, 1)),),
              SizedBox(height: 20),
              _DocumentMoralPerson()
            ],
          ),
        ),
      ),
...
class _DocumentMoralPerson extends StatelessWidget {
  const _DocumentMoralPerson({super.key});
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: const <DataColumn>[
            ...
            DataColumn(label: Expanded(child: Text('D'))),
          ],
          rows: const <DataRow>[
