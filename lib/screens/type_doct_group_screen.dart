...
class TypeDoctGroupScreen extends StatelessWidget {
  const TypeDoctGroupScreen({super.key});
      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Documentos para personas empresas', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Color.fromRGBO(2, 63, 120, 1)),),
              SizedBox(height: 20),
              _documetn()
            ],
          ),
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: const <DataColumn>[
            ...
            DataColumn(label: Expanded(child: Text('Infra'))),
            DataColumn(label: Expanded(child: Text('Gobierno'))),
          ],
          rows: <DataRow>[
